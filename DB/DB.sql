...
(
  ...
  USER_ID INT AUTO_INCREMENT NOT NULL,
  PRIMARY KEY (USER_ID),
  FOREIGN KEY (USER_ID) REFERENCES Luxville.EXTERNAL_USER(USER_ID),
  UNIQUE (BUYER_SSN)
);

CREATE TABLE Luxville.SELLER
(
  SELLER_SSN VARCHAR(20) NOT NULL,
...
(
  ...
  FOREIGN KEY (OWNER_ID) REFERENCES Luxville.OWNER(USER_ID),
  FOREIGN KEY (SELLER_ID) REFERENCES Luxville.SELLER(USER_ID)
);
...
(
  ...
  PRIMARY KEY (DEAL_ID),
  FOREIGN KEY (BUYER_ID) REFERENCES Luxville.BUYER(USER_ID),
  FOREIGN KEY (SELLER_ID) REFERENCES Luxville.SELLER(USER_ID),
...
(
  ...
  FOREIGN KEY (CLIENT_ID) REFERENCES Luxville.CLIENT(USER_ID),
  FOREIGN KEY (AGENT_ID) REFERENCES Luxville.SYSTEM_USER(USER_ID),
  FOREIGN KEY (PROPERTY_ID) REFERENCES Luxville.PROPERTY(PROPERTY_ID)
);
