...
CREATE TABLE Luxville.PERMISSION(
    -- #Attributes
    ROLE_ID INT,
    PERMISSION_ID INT AUTO_INCREMENT UNIQUE NOT NULL,
...
CREATE TABLE Luxville.SYSTEMUSER(
    -- #Attributes
    USER_ID INT,
    SYSTEMUSER_ID INT AUTO_INCREMENT UNIQUE NOT NULL,
...
CREATE TABLE Luxville.EXTERNALUSER(
    -- #Attributes
    EXTERNALUSER_ID INT AUTO_INCREMENT UNIQUE NOT NULL,
    USER_ID INT,
...
CREATE TABLE Luxville.BUYER(
    -- #Attributes
    BUYER_ID INT AUTO_INCREMENT UNIQUE NOT NULL,
    EXTERNALUSER_ID INT,
    USER_ID INT,
...
CREATE TABLE Luxville.SELLER(
    -- #Attributes
    SELLER_ID INT AUTO_INCREMENT UNIQUE NOT NULL,
    EXTERNALUSER_ID INT,
    USER_ID INT,
...
CREATE TABLE Luxville.OWNER(
    -- #Attributes
    OWNER_ID INT AUTO_INCREMENT UNIQUE NOT NULL,
    EXTERNALUSER_ID INT,
    USER_ID INT,
...
CREATE TABLE Luxville.AUDITLOG(
    ...
    USER_ID INT,
    SYSTEMUSER_ID INT,
    AUDITLOG_ID INT AUTO_INCREMENT UNIQUE NOT NULL,
...
CREATE TABLE Luxville.STUDIO(
    -- #Attributes
    PROPERTY_ID VARCHAR(20),
    STUDIO_ID INT AUTO_INCREMENT UNIQUE NOT NULL,
    OWNER_ID INT,
    OWNER_EXTERNALUSER_ID INT,
    OWNER_USER_ID INT,
...
CREATE TABLE Luxville.OFFICE(
    -- #Attributes
    PROPERTY_ID VARCHAR(20),
    OFFICE_ID INT AUTO_INCREMENT UNIQUE NOT NULL,
    OWNER_ID INT,
    OWNER_EXTERNALUSER_ID INT,
    OWNER_USER_ID INT,
    FLOOR_NUMBER INT NOT NULL,
...
CREATE TABLE Luxville.APARTMENT(
    -- #Attributes
    PROPERTY_ID VARCHAR(20),
    APARTMENT_ID INT AUTO_INCREMENT UNIQUE NOT NULL,
    OWNER_ID INT,
    OWNER_EXTERNALUSER_ID INT,
    OWNER_USER_ID INT,
    FLOOR_NUMBER INT NOT NULL,
...
CREATE TABLE Luxville.HOUSE(
    -- #Attributes
    PROPERTY_ID VARCHAR(20),
    HOUSE_ID INT AUTO_INCREMENT UNIQUE NOT NULL,
    OWNER_ID INT,
    OWNER_EXTERNALUSER_ID INT,
    OWNER_USER_ID INT,
    NUMBER_OF_BATHROOMS INT NOT NULL,
...
CREATE TABLE Luxville.LAND(
    -- #Attributes
    PROPERTY_ID VARCHAR(20),
    LAND_ID INT AUTO_INCREMENT UNIQUE NOT NULL,
    OWNER_ID INT,
    OWNER_EXTERNALUSER_ID INT,
    OWNER_USER_ID INT,
